  ...
  return (
    <ScrollView>
      ...
      <View style={styles.screen}>
        ...
        <TextInput autoCapitalize="none" accessibilityRole="text" style={styles.input} id="username" label="username" value={props.username} keyboardType="default" required defaultValue="Enter username" autoCompleteType="off" errorText="Please enter a username." onChangeText={text => props.setUsername(text)}
          initialValue="" />
      </View>
      <View style={styles.screen}>
